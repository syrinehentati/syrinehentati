...
| Area | Technologies |
|------|-------------|
| Backend | NestJS, Python, TypeScript, GraphQL |
| AI | Gemini API, MCP, RAG, vector embeddings |
...
- 🔬 R&D Intern @ **Carleton University**, Ottawa, Canada
- 🏭 Microservices + GraphQL API Gateway @ **ASQII HealthTech**
- 🔗 OAuth 2.0 + QuickBooks integration @ **SeekMake**
...
📫 syrine.hentati.eng@gmail.com · [LinkedIn](https://linkedin.com/in/syrine-hentati-153423251)
